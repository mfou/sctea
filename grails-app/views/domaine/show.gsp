                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:domaineInstance, field:'id')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Nom Domaine:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:domaineInstance, field:'nomDomaine')}</td>
